...
class CompletionsProviderImpl {
    ...
    async getCompletions(document, position, completionContext, cancellationToken) {
        ...
        const addCompletion = (entry, asStore) => {
            if (isValidCompletion(entry)) {
                let completion = this.toCompletionItem(tsDoc, entry, fileUrl, position, isCompletionInTag, commitCharactersOptions, asStore, existingImports);
                if (completion) {
    ...
    toCompletionItem(snapshot, comp, uri, position, isCompletionInTag, commitCharactersOptions, asStore, existingImports) {
